...
ImportedModel myModel("res/models/spaceShuttle/shuttle.obj");
...
{
	renderingProgram = Utils::createShaderProgram("res/shaders/spaceShuttle/basic.vert", "res/shaders/spaceShuttle/basic.frag");
	...
	setupVertices();
	shuttleTexture = Utils::loadTexture("res/textures/spaceShuttle/spstob_1.jpg");
}
...
int main(void)
{
	...
	GLFWwindow* window = glfwCreateWindow(600, 600, "spaceShuttle", NULL, NULL);
